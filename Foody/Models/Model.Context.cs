...
namespace Foody.Models
{
    ...
    public partial class FoodDeliveryEntities : DbContext
    {
        ...
        public virtual int GET_LIST_INVOICE_BY_CUSTOMERID_ALL(string customerID)
        {
            var customerIDParameter = customerID != null ?
                new ObjectParameter("CustomerID", customerID) :
                new ObjectParameter("CustomerID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GET_LIST_INVOICE_BY_CUSTOMERID_ALL", customerIDParameter);
        }
        ...
        public virtual int INSERT_CUSTOMER_TOSQL(string fullName, string address, string mobile, string userName, string password, string email, string avatar, Nullable<double> locationX, Nullable<double> locationY, string userType)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("INSERT_CUSTOMER_TOSQL", fullNameParameter, addressParameter, mobileParameter, userNameParameter, passwordParameter, emailParameter, avatarParameter, locationXParameter, locationYParameter, userTypeParameter);
        }
        ...
        public virtual int UPDATE_CUSTOMER_TOSQL(string userName, string fullName, string address, string mobile, string userType, string password, string email, string avatar, Nullable<double> locationX, Nullable<double> locationY)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UPDATE_CUSTOMER_TOSQL", userNameParameter, fullNameParameter, addressParameter, mobileParameter, userTypeParameter, passwordParameter, emailParameter, avatarParameter, locationXParameter, locationYParameter);
        }
